...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        Hyderabad 500081, India \hspace{5 pt} | \hspace{5 pt}
    ...
    \textbf{LinkedIn Post Generator for Content Creators} \href{https://github.com/vidhanrathore/LinkedIn-Post-Generator}{\faGithub} \hfill \textit{LangChain, OpenAI API, ChromaDB, Groq API, Prompt Engineering, Python} \\
    \begin{highlights}
    ...
    \textbf{Smart Resume Feedback Assistant} \href{https://github.com/vidhanrathore/Smart-Resume-Feedback-Assistant}{\faGithub} \hfill \textit{LangChain, OpenAI API, FastAPI, Streamlit, Prompt Engineering, Python} \\
    \begin{highlights}
        \item Built an \textbf{LLM-powered} resume feedback tool using \textbf{LangChain} and \textbf{OpenAI API} that analyzes resumes against job descriptions, providing actionable, section-wise improvement suggestions via advanced \textbf{Prompt Engineering}.
        \item Developed a \textbf{FastAPI} backend with \textbf{Streamlit} frontend enabling real-time, structured feedback on skills, experience alignment, and keyword gaps — reducing manual resume review effort significantly.
    \end{highlights}
    \vspace{0.05 cm}
    ...
    \begin{onecolentry}
        ...
        Samrat Ashok Technological Institute \hfill CGPA: \textbf{8.78 / 10} \\[0.10cm]
        \textbf{Class XII \& X} -- The Oxford H.S. School, Sehore \hfill XII: \textbf{90\%} (2019)\hspace{5pt}|\hspace{5pt} X: \textbf{84.5\%} (2017)
    \end{onecolentry}
    \vspace{0.05 cm}
